...
export class PracticaService {
  ...
  getItemByFecha(fechaDesde: string, fechaHasta: string) {
    return this.http.get<OperacionCobro>(
      this.url +
        '/by/fecha/orden?fecha_desde=' +
        fechaDesde +
        '&fecha_hasta=' +
        fechaHasta
    );
  ...
  getItemByFechaAndObraSocialAndMedico(
    fechaDesde: string,
    fechaHasta: string,
    medico_id: string,
  ...
  getOperacionCobroRegistrosBetweenDates(
    ...
    return this.http.get<OperacionCobroDetalle[]>(
      this.URL_OPERACION_COBRO +
        'registros/by/dates?fecha_desde=' +
        fecha_desde +
        '&fecha_hasta=' +
        fecha_hasta +
        '&estado_liquidacion=' +
  ...
  getOperacionCobroRegistrosBetweenDatesAndMedico(
    fecha_desde: string,
    fecha_hasta: string,
    estado_liquidacion: string,
    ...
    return this.http.get<OperacionCobroDetalle[]>(
      this.URL_OPERACION_COBRO +
        'registros/by/dates/medico?fecha_desde=' +
        fecha_desde +
        '&fecha_hasta=' +
        fecha_hasta +
        '&estado_liquidacion=' +
  ...
  getOperacionCobroRegistrosById(
    fecha_desde: string,
    fecha_hasta: string,
    estado_liquidacion: string,
    user_medico_id: string
  ...
  getOperacionCobroRegistrosByIdOperacionCobro(id: string) {
    return this.http.get<OperacionCobroDetalle[]>(
      this.URL_OPERACION_COBRO + 'registros/by/operacioncobro?id=' + id
    );
  }

  getOperacionCobroRegistrosByPaciente(id: string) {
    return this.http.get<OperacionCobroDetalle[]>(
      this.URL_OPERACION_COBRO + 'registros/by/paciente?id=' + id
    );
  }
  getOperacionCobroRegistrosByLiquidacionNumero(id: string) {
    return this.http.get<OperacionCobroDetalle[]>(
      this.URL_OPERACION_COBRO + 'registros/by/liquidacion/numero?id=' + id
    );
  }

  getOperacionCobroRegistrosByLiquidacionNumeroMultiple(selected: any) {
    return this.http.post<any[]>(
      this.URL_OPERACION_COBRO + 'registros/by/liquidacion/numero/multiple',
      selected
    );
  }
  ...
  async getOperacionCobroDistribucionById(
    id: string,
    estado_liquidacion: string,
    obra_social_id: string
  ): Promise<any[]> {
  ...
  async getOperacionCobroDistribucionByIdPrefactura(
    id: string,
    estado_liquidacion: string,
    obra_social_id: string
  ): Promise<any[]> {
    return await this.http
      .get<any[]>(
        this.URL_OPERACION_COBRO +
          'registros/by/distribucion/prefactura?id=' +
          id +
          '&estado_liquidacion=' +
          estado_liquidacion +
          '&obra_social_id=' +
  ...
  auditarpractica(registros: OperacionCobroDetalle[]) {
    return this.http.post<number>(
      this.URL_OPERACION_COBRO + 'facturacion/auditarorden',
      registros
    );
  }
  ...
  afectarOperacionCobro(liquidacion: Liquidacion) {
    ...
    return this.http.post<any>(
      this.URL_OPERACION_COBRO + 'afectar/orden',
      liquidacion
    );
  }
  ...
  destroyByPracticaById(id: string) {
    return this.http.delete<number>(
      this.URL_OPERACION_COBRO + 'practica/' + id
    );
  }
  ...
  putOperacionCobro(val: OperacionCobro, id: string) {
    ...
    return this.http.put<any>(
      URL_SERVICIOS + 'operacioncobro/operacioncobro/actualizar/' + id,
      val
    );
  }
  ...
  putOperacionCobroRegistro(val: OperacionCobro, id: string) {
    console.log(val);
    return this.http.put<any>(
      URL_SERVICIOS + 'operacioncobro/practica/actualizar/' + id,
      val
    );
  }
  ...
  putOperacionCobroRegistroAnular(val: any, id: string) {
    console.log(val);
    return this.http.put<any>(
      URL_SERVICIOS + 'operacioncobro/practica/anular/' + id,
      val
    );
  }
  ...
  actualizarValoresPracticasByConvenio(selected: any) {
    return this.http.post<any[]>(
      URL_SERVICIOS + 'operacioncobro/recalcular/by/liquidacion',
      selected
    );
  ...
  desafectarPresentacion(liquidacion_nro: string) {
    return this.http.get<any>(
      URL_SERVICIOS +
        'liquidacion/detalle/prefactura/desafectar?liquidacion_nro=' +
        liquidacion_nro
    );
  }
  ...
  updatePresentacion(registro: any, id: string) {
    return this.http.put<any>(
      this.URL_OPERACION_COBRO + 'presentacion/actualizar/' + id,
      registro
    );
  }
  ...
  updatePrestacion(id: string, prestacion: any) {
    return this.http.put<any>(
      this.URL_OPERACION_COBRO + 'registro/prestacion/' + id,
      prestacion
    );
  }
  ...
  getDistribucionbyOperacionCobro(operacion_cobro_id: string) {
    return this.http.get<OperacionCobroDetalle[]>(
      this.URL_OPERACION_COBRO +
        'distribucion/by/operacioncobro?operacion_cobro_id=' +
        operacion_cobro_id
    );
  }
  ...
  getOperacionCobroByDistribucion(fecha_desde: string, fecha_hasta: String) {
    return this.http.get<any[]>(
      this.URL_OPERACION_COBRO +
        'consulta/varios/distribucion?fecha_desde=' +
        fecha_desde +
        '&fecha_hasta=' +
        fecha_hasta
    );
  ...
  updateOperacionCobroDistribucionOperacionCobro(registro: any) {
    return this.http.put<any>(
      this.URL_OPERACION_COBRO +
        'practica/editar/distribucion/operacioncobro/' +
        registro['operacion_cobro_id'],
      registro
    );
  }
}
