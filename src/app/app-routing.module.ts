...
const routes: Routes = [
  ...
  {
    path: 'cirugiagrupo',
    component: CirugiaGrupoComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  {
    path: 'distribucion',
    component: DistribucionPracticaComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  {
  ...
  /** mantenimiento de agenda */
  {
    ...
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  {
    path: 'agenda/medico/bloquear',
    component: AgendaBloqueoComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  {
    path: 'agenda/medico/desbloquear',
    component: AgendaBloqueoEdicionComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  /** factura **/
  {
    path: 'factura/articulo',
    component: FacturacionArticuloComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  /** asesoramiento **/

  {
    ...
    component: ListadoCirugiaComponent,
    canActivate: [AuthGuard],
    data: { role: 'asesoramiento_control' },
  },
  {
    path: 'asesoramiento/cirugia/cirugia/listas',
    component: ListadoCirugiaQuirofanoComponent,
    canActivate: [AuthGuard],
    data: { role: 'asesoramiento_control' },
  },
  {
    path: 'asesoramiento/operacioncobro',
    component: OperacionCobroComponent,
    canActivate: [AuthGuard],
    data: { role: 'asesoramiento_consulta' },
  },

  /** facturacion**/
  {
    path: 'facturacion/liquidacion/generada',
    component: LiquidacionGeneradaComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  {
  ...
  {
    path: 'facturacion/liquidacion/liquidar',
    component: LiquidarComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  {
    path: 'facturacion/operacioncobro',
    component: OperacionCobroComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_consulta' },
  },
  {
    path: 'liquidacion/operacioncobro/detalle',
    component: OperacionCobroDetalleComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_consulta' },
  },
  {
    path: 'liquidacion/operacioncobro/auditar',
    component: OperacionCobroAuditarComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  {
    path: 'liquidacion/operacioncobro/afectar',
    component: OperacionCobroAfectarComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  {
    path: 'facturacion/liquidacion/confeccion',
    component: ConfeccionFacturaComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },

  {
    path: 'facturacion/liquidacion/presentacion',
    component: LiquidacionDetalleComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },

  {
    ...
    canActivate: [AuthGuard],
    data: { role: 'recepcion_consulta' },
  },
  {
    path: 'recepcion/factura/acciones',
  ...
  /** recepcion **/
  {
    ...
    component: AgendaRecepcionComponent,
    canActivate: [AuthGuard],
    data: { role: 'recepcion_consulta' },
  },
  {
    path: 'recepcion/telefonista/agenda',
  ...
  /** stock **/
  {
    path: 'stock/lente/stock',
    component: AltaLenteComponent,
    canActivate: [AuthGuard],
    data: { role: 'facturacion_control' },
  },
  ...
  {
    path: 'estudio/cargar',
    component: EstudioCargaComponent,
    canActivate: [AuthGuard],
    data: { role: 'estudios_control' },
  },
  ...
  /** medicos**/
  {
    ...
    component: TurnoComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_consulta' },
  },
  {
    path: 'gestion/agenda',
    component: AgendaAtencionMedicoComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_consulta' },
  },
  {
    path: 'medico/historiaclinica',
  ...
  },
  {
    ...
    component: HistoriaClinicaVisualizarComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  {
    path: 'medico/operacioncobro/detalle',
    component: OperacionCobroDetalleMedicoComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  {
    path: 'medico/operacioncobro/listado/cirugia',
    component: ListadoCirugiaEditarComponent,
    canActivate: [AuthGuard],
    data: { role: 'medico_control' },
  },
  ...
  },
  {
    ...
    component: OperacionCobroConsultaGerenciaComponent,
    canActivate: [AuthGuard],
    data: { role: 'gerencia_control' },
  },
  {
    path: 'gerencia/operacioncobro/detalle',
    component: GerenciaDetalleOperacionCobroComponent,
    canActivate: [AuthGuard],
    data: { role: 'gerencia_control' },
  },
  {
  ...
  /** quirofano */
  {
    path: 'medico/cirugia/listado/cirugia',
    component: ListadoCirugiaEditarComponent,
    canActivate: [AuthGuard],
    data: { role: 'quirofano_control' },
  },
  {
    path: 'quirofona/cirugia/listado/cirugia',
    component: ListadoCirugiaQuirofanoConsultaComponent,
    canActivate: [AuthGuard],
    data: { role: 'quirofano_control' },
  },
  /** stock */
