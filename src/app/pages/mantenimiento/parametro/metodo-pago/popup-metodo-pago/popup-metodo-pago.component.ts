...
@Component({
  selector: 'app-popup-metodo-pago',
  templateUrl: './popup-metodo-pago.component.html',
  styles: [],
})
export class PopupMetodoPagoComponent implements OnInit {
  ...
  crear() {
    ...
    try {
      this.parametroService
        .setParametroMetodoPago(this.updateDataForm.value)
        .subscribe(
          (resp) => {
            this.loading = false;
            console.log(resp);
