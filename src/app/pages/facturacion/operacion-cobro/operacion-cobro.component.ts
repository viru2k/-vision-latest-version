...
export class OperacionCobroComponent implements OnInit {
  ...
  constructor(
    private miServico: PracticaService,
  ...
  ngOnInit() {
    ...
    this.popItemAgenda = new AgendaTurno(
      '',
      new Date(),
      new Date(),
      new Date(),
    ...
    this.popItemPaciente = new Paciente(
      '0',
      '',
      '',
      '',
    ...
    this.popItemMedicoObraSocial = new MedicoObraSocial(
      '',
      '',
      '',
      '',
  ...
  actualizarFecha(event) {
    console.log(event);
    this.fechaHoy = event;
    this._fechaHoy = formatDate(
      new Date(this.fechaHoy),
      'yyyy-MM-dd HH:mm',
      'es-AR'
    );
  ...
  buscarMedico() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        ...
        this.popItemMedicoObraSocial.apellido =
          PopupMedicoComponent.apellido + ' ' + PopupMedicoComponent.nombre;
        ...
        this.formMedico.patchValue({
          usuario_id: PopupMedicoComponent.usuario_id,
        });
        this.medico_antiguedad =
          new Date().getFullYear() -
          new Date(PopupMedicoComponent.fecha_matricula).getFullYear();
        console.log(this.medico_antiguedad);
        this.operacionCobroMedico = new OperacionCobroMedico(
          '0',
          '0',
          PopupMedicoComponent.usuario_id,
          '0'
        );
      }
    });
  ...
  cargarAgendaDesdeInicio(PopupAgendaComponent: AgendaTurno) {
    ...
    this.formPaciente.patchValue({
      apellido: PopupAgendaComponent.paciente_apellido,
    });
    this.formPaciente.patchValue({
      nombre: PopupAgendaComponent.paciente_nombre,
    });
    this.formPaciente.patchValue({
      fecha_nacimiento: PopupAgendaComponent.paciente_fecha_nacimiento,
    });
    this.formObraSocial.patchValue({
      coseguro_id: PopupAgendaComponent.paciente_coseguro_id,
    });
    this.formObraSocial.patchValue({
      es_coseguro: PopupAgendaComponent.coseguro_es_coseguro,
    });
    this.formObraSocial.patchValue({
      tiene_distribucion: PopupAgendaComponent.tiene_distribucion,
    });
    this.formObraSocial.patchValue({
      id: PopupAgendaComponent.paciente_obra_social_id,
    });
    this.formObraSocial.patchValue({
      nombre: PopupAgendaComponent.paciente_obra_social_nombre,
    });
    this.formObraSocial.patchValue({
      coseguro_id: PopupAgendaComponent.paciente_coseguro_id,
    });
    this.formObraSocial.patchValue({
      coseguro_nombre: PopupAgendaComponent.paciente_coseguro_nombre,
    });
    this.formDatosObraSocial.patchValue({
      numero_afiliado: PopupAgendaComponent.numero_afiliado,
    });
    this.formDatosObraSocial.patchValue({
      barra_afiliado: PopupAgendaComponent.barra_afiliado,
    });
    ...
    this.formMedico.patchValue({
      apellido: PopupAgendaComponent.nombreyapellido,
    });
    this.formMedico.patchValue({ usuario_id: PopupAgendaComponent.usuario_id });
    this.formMedico.patchValue({
      fecha_matricula: PopupAgendaComponent.fecha_matricula,
    });
    this.medico_antiguedad =
      new Date().getFullYear() -
      new Date(this.formMedico.value.fecha_matricula).getFullYear();
    console.log(this.medico_antiguedad);
    this.popItemCoseguro.id = PopupAgendaComponent.paciente_coseguro_id;
    this.popItemCoseguro.es_coseguro =
      PopupAgendaComponent.coseguro_es_coseguro;
    this.popItemCoseguro.tiene_distribucion =
      PopupAgendaComponent.tiene_distribucion;
    ...
    this.operacionCobroMedico = new OperacionCobroMedico(
      '0',
      '0',
      this.formMedico.value.usuario_id,
      '0'
    );
    ...
    console.log(PopupAgendaComponent);
    if (
      PopupAgendaComponent.usuario_id !==
      PopupAgendaComponent.usuario_medico_factura_id
    ) {
      swal({
        title: 'Diferencia en medicos a facturar',
        text:
          'El médico  del turno ' +
          PopupAgendaComponent.nombreyapellido +
          ' es distinto al que se va a realizar la O.C que es : ' +
          PopupAgendaComponent['nombreyapellido_factura'],
        type: 'info',
        ...
        if (result.value) {
          ...
          this.popItemMedicoObraSocial.apellido =
            PopupAgendaComponent['nombreyapellido_factura'];
          this.popItemMedicoObraSocial.medico_id =
            PopupAgendaComponent['usuario_medico_factura_id'];
          this.medico_antiguedad =
            new Date().getFullYear() -
            new Date(
              PopupAgendaComponent['fecha_matricula_factura']
            ).getFullYear();
          ...
          this.formMedico.patchValue({
            apellido: PopupAgendaComponent['nombreyapellido_factura'],
          });
          this.formMedico.patchValue({
            usuario_id: PopupAgendaComponent['usuario_medico_factura_id'],
          });
          this.formMedico.patchValue({
            fecha_matricula: PopupAgendaComponent['fecha_matricula_factura'],
          });
  ...
  buscarAgenda() {
    ...
    ref.onClose.subscribe((PopupAgendaComponent: AgendaTurno) => {
      if (PopupAgendaComponent) {
        ...
        this.formPaciente.patchValue({ id: PopupAgendaComponent.paciente_id });
        this.formPaciente.patchValue({
          dni: PopupAgendaComponent.paciente_dni,
        });
        this.formPaciente.patchValue({
          apellido: PopupAgendaComponent.paciente_apellido,
        });
        ...
        this.formMedico.patchValue({
          usuario_id: PopupAgendaComponent.usuario_id,
        });
        this.formMedico.patchValue({
          fecha_matricula: PopupAgendaComponent.fecha_matricula,
        });
        ...
        this.popItemCoseguro.tiene_distribucion =
          PopupAgendaComponent.tiene_distribucion;
        this.popItemCoseguro.nombre =
          PopupAgendaComponent.paciente_coseguro_nombre;
        this.popItemAgenda = this.formAgenda.value;
        this.popItemPaciente = this.formPaciente.value;
        this.popItemObraSocial = this.formObraSocial.value;
        console.log(this.formObraSocial.value.tiene_distribucion);
  ...
  buscarPaciente() {
    ...
    ref.onClose.subscribe((PopupPacienteObrasocialComponent: Paciente) => {
      if (PopupPacienteObrasocialComponent) {
        ...
        this.popItemPaciente.apellido =
          PopupPacienteObrasocialComponent.apellido;
        this.popItemPaciente.dni = PopupPacienteObrasocialComponent.dni;
        this.popItemPaciente.fecha_nacimiento =
          PopupPacienteObrasocialComponent.fecha_nacimiento;
        this.popItemPaciente.domicilio =
          PopupPacienteObrasocialComponent.domicilio;
        this.popItemPaciente.es_coseguro =
          PopupPacienteObrasocialComponent.es_coseguro;
        this.popItemPaciente.tiene_distribucion =
          PopupPacienteObrasocialComponent.tiene_distribucion;
        this.popItemPaciente.coseguro_tiene_distribucion =
          PopupPacienteObrasocialComponent.coseguro_tiene_distribucion;
        this.popItemPaciente.coseguro_es_coseguro =
          PopupPacienteObrasocialComponent.coseguro_es_coseguro;
        this.popItemPaciente.id = PopupPacienteObrasocialComponent.id;
        this.popItemObraSocial.nombre =
          PopupPacienteObrasocialComponent.obra_social_nombre;
        this.popItemObraSocial.id = PopupPacienteObrasocialComponent.id;
        this.popItemObraSocial.es_coseguro =
          PopupPacienteObrasocialComponent.es_coseguro;
        this.popItemCoseguro.nombre =
          PopupPacienteObrasocialComponent.coseguro_nombre;
        ...
        this.formObraSocial.patchValue({
          id: PopupPacienteObrasocialComponent.obra_social_id,
        });
        this.formObraSocial.patchValue({
          nombre: PopupPacienteObrasocialComponent.obra_social_nombre,
        });
        this.formObraSocial.patchValue({
          coseguro_nombre: PopupPacienteObrasocialComponent.coseguro_nombre,
        });
        this.formObraSocial.patchValue({
          coseguro_id: PopupPacienteObrasocialComponent.coseguro_id,
        });
        this.formObraSocial.patchValue({
          obra_social_id_id: PopupPacienteObrasocialComponent.obra_social_id,
        });
        this.formDatosObraSocial.patchValue({
          barra_afiliado: PopupPacienteObrasocialComponent.barra_afiliado,
        });
        this.formDatosObraSocial.patchValue({
          numero_afiliado: PopupPacienteObrasocialComponent.numero_afiliado,
        });
  ...
  buscarObraSocialCoseguro() {
    ...
    ref.onClose.subscribe((PopupObraSocialComponent: ObraSocial) => {
      if (PopupObraSocialComponent) {
        ...
        this.formObraSocial.patchValue({
          coseguro_id: this.popItemCoseguro.id,
        });
        this.formObraSocial.patchValue({
          coseguro_nombre: this.popItemCoseguro.nombre,
        });
      }
    });
  }
  ...
  CrearEditarPaciente() {
    ...
    if (this.formPaciente.value.id == '0') {
      this.throwAlert(
        'warning',
        'No se puede editar sin seleccionar un paciente',
        'Debe seleccionar un paciente previamente',
        '404'
      );
    } else {
    ...
    ref.onClose.subscribe((PopupPacienteNuevoComponent: Paciente) => {
      if (PopupPacienteNuevoComponent) {
       ...
       this.popItemPaciente.domicilio = PopupPacienteNuevoComponent.domicilio;   */
        this.popItemObraSocial.nombre =
          PopupPacienteNuevoComponent.obra_social_nombre;
        this.popItemObraSocial.es_coseguro =
          PopupPacienteNuevoComponent.es_coseguro;
        this.popItemObraSocial.id = PopupPacienteNuevoComponent.obra_social_id;
        this.popItemCoseguro.nombre =
          PopupPacienteNuevoComponent.coseguro_nombre;
        this.popItemCoseguro.id = PopupPacienteNuevoComponent.coseguro_id;
        this.formPaciente.patchValue(this.popItemPaciente);

        this.formObraSocial.patchValue({
          id: PopupPacienteNuevoComponent.obra_social_id,
        });
        this.formObraSocial.patchValue({
          nombre: PopupPacienteNuevoComponent.obra_social_nombre,
        });
        this.formObraSocial.patchValue({
          coseguro_nombre: PopupPacienteNuevoComponent.coseguro_nombre,
        });
        this.formObraSocial.patchValue({
          coseguro_id: PopupPacienteNuevoComponent.coseguro_id,
        });
        this.formDatosObraSocial.patchValue({
          barra_afiliado: PopupPacienteNuevoComponent.barra_afiliado,
        });
        this.formDatosObraSocial.patchValue({
          numero_afiliado: PopupPacienteNuevoComponent.numero_afiliado,
        });
  ...
  nuevoPaciente() {
    try {
      ...
      this.pacienteService
        .putItem(this.popItemPaciente, this.formPaciente.value.id)
        .subscribe(
          (resp) => {
            console.log(resp);
            this.loading = false;
  ...
  ObtenerPaciente() {
    try {
      ...
      //  console.log(this.popItem.id);
      this.pacienteService.getItem(this.formPaciente.value.id).subscribe(
        (resp) => {
          console.log(resp[0]);
          this.loading = false;
  ...
  agregarPractica() {
    ...
    if (this.popItemPaciente.dni != '') {
      ...
      ref.onClose.subscribe(
        (PopupPracticaPorcentajeComponent: OperacionCobroPractica) => {
          if (PopupPracticaPorcentajeComponent) {
            ...
            if (
              ...
              if (PopupPracticaPorcentajeComponent.pmo_nivel != '1') {
                ...
                if (
                  ...
                  this.cargarDistribucion(
                    PopupPracticaPorcentajeComponent.convenio_os_pmo_id,
                    PopupPracticaPorcentajeComponent
                  );
                }
              ...
              this.total_obra_social_coseguro =
                this.total_obra_social + this.total_coseguro;
              this.valTotalFinal =
                this.total_obra_social +
                this.total_coseguro +
                this.total_categoria; //--> movido a cargar distribuccion
            }

            if (
              PopupPracticaPorcentajeComponent.obra_social_id == '99' &&
              PopupPracticaPorcentajeComponent.es_coseguro == 'S'
            ) {
              console.log('PRACTICA QUE ES COSEGURO');
              this.operacionCobroPractica = new OperacionCobroPractica(
                PopupPracticaPorcentajeComponent.id,
                PopupPracticaPorcentajeComponent.convenio_os_pmo_id,
                PopupPracticaPorcentajeComponent.obra_social_nombre +
                  ' - ' +
                  PopupPracticaPorcentajeComponent.pmo_descripcion,
                PopupPracticaPorcentajeComponent.obra_social_nombre,
                PopupPracticaPorcentajeComponent.obra_social_id,
                Number(PopupPracticaPorcentajeComponent.valor_original),
                PopupPracticaPorcentajeComponent.valor_facturado,
                PopupPracticaPorcentajeComponent.operacion_cobro_id,
                PopupPracticaPorcentajeComponent.observacion,
                PopupPracticaPorcentajeComponent.pmo_id,
                PopupPracticaPorcentajeComponent.pmo_nivel,
                this.categoria_obra_social,
                PopupPracticaPorcentajeComponent.cantidad,
                PopupPracticaPorcentajeComponent.es_coseguro,
                PopupPracticaPorcentajeComponent.tiene_distribucion,
                this.total_honorario_obra_social,
                this.total_honorario_coseguro,
                PopupPracticaPorcentajeComponent.forma_pago,
                this.usuario_id,
                'P',
                PopupPracticaPorcentajeComponent.usuario_cobro_nombre,
                'NO',
                '-',
                '',
                'NO',
              ...
              if (this.operacionCobroPractica.obra_social_id == '99') {
                ...
                if (
                  ...
                  this.tmp_operacionCobroPractica.forma_pago =
                    PopupPracticaPorcentajeComponent.forma_pago;
                this.total_efectivo =
                  this.total_efectivo +
                  Number(PopupPracticaPorcentajeComponent.valor_facturado);
              }
              this.total_obra_social_coseguro =
                this.total_obra_social + this.total_coseguro;
              this.total_obra_social =
            ...
            console.log(
              'PRACTICA PORCENTAJE ' + PopupPracticaPorcentajeComponent
            );

            if (
              PopupPracticaPorcentajeComponent.es_coseguro == 'N' &&
              PopupPracticaPorcentajeComponent.tiene_distribucion == 'N'
            ) {
              this.operacionCobroPractica = new OperacionCobroPractica(
                PopupPracticaPorcentajeComponent.id,
                PopupPracticaPorcentajeComponent.convenio_os_pmo_id,
              ...
              console.log(this.operacionCobroPractica);
              if (
                this.operacionCobroPractica.obra_social_id == '86' ||
                this.operacionCobroPractica.obra_social_id == '99'
              ) {
                //si es particular y paga con una forma no trasnferencia lo calculo
                if (
                  PopupPracticaPorcentajeComponent.forma_pago != 'TRANSFERENCIA'
                ) {
                  this.total_efectivo =
                    this.total_efectivo +
                    PopupPracticaPorcentajeComponent.valor_facturado;
  ...
  cargarDistribucion(
    ...
    try {
      ...
      this.practicaDistribucionService.getItems(id).subscribe(
        (resp) => {
          ...
          if (resp.length === undefined) {
            ...
            console.log(
              'practica pmo  ' + this.tmp_operacionCobroPractica.pmo_nivel
            );
            let pmo_nivel = Number(this.tmp_operacionCobroPractica.pmo_nivel);
            console.log('sin asociacion para buscar honorarios');
            if (pmo_nivel === 2) {
              console.log(
                'pmo id ' + this.popItemCoseguro.id,
                PopupPracticaPorcentajeComponent.pmo_id
              );
              this.obtenerCodigoCoseguro(
                this.popItemCoseguro.id,
                PopupPracticaPorcentajeComponent.pmo_id
              );
            }
            if (pmo_nivel === 4) {
  ...
  async obtenerCodigoCoseguro(obra_social_id: string, pmo_id: string) {
    ...
    try {
      ...
      this.obraSocialService
        .getObraSocialByIdAndPmo(obra_social_id, pmo_id)
        .subscribe(
          (resp) => {
            // CUANDO TENGO EL RESULTADO SUMO SOBRE LA VARIABLE QUE SE LLAMA HONORARIOS
            this.loading = false;
            ...
            if (this.practicaDistribucionElements != null) {
              this.practicaDistribucionElements.forEach((element) => {
                ...
                this.obra_social_practica_nombre =
                  element['obra_social_practica_nombre'];
                this.practica_distribucion_total =
                  element['practica_distribucion_total'];

                if (this.obra_social_practica_nombre == 'HONORARIOS') {
                  console.log(
                    'PRACTICA TOTAL HONORARIOS ' +
                      this.practica_distribucion_total
                  );
                  ...
                  this.categoria_obra_social =
                    this.categoria_obra_social +
                    this.calcularCategoria(this.practica_distribucion_total, 0);
                  ...
                  this.total_honorario_obra_social = this.calcularCategoria(
                    this.practica_distribucion_total,
                    0
                  );
                  console.log(
                    'categoria obra socia : ' + this.categoria_obra_social
                  );
                  console.log(
                    'horonario obra socia : ' + this.total_honorario_obra_social
                  );

                  console.log(
                    'TOTAL HONORARIO OBRA SOCIAL ' +
                      this.total_honorario_obra_social
                  );
                  this.categoria_coseguro =
                    this.categoria_coseguro +
                    this.calcularCategoria(
                      0,
                      this.cargarCoseguroRegistro(
                        this.practica_distribucion_total
                      )
                    );
                  this.total_honorario_coseguro = this.calcularCategoria(
                    0,
                    this.cargarCoseguroRegistro(
                      this.practica_distribucion_total
                    )
                  ...
                  console.log(
                    'categoria coseguro : ' + this.categoria_coseguro
                  );
                  console.log(
                    'horonario coseguro : ' + this.total_honorario_coseguro
                  );
                  console.log(
                    'suma de categoria obra social: coseguro' +
                      this.categoria_coseguro +
                      ' obra social' +
                      this.categoria_obra_social
                  );
                  this.total_categoria =
                    this.categoria_obra_social + this.categoria_coseguro;
              ...
              let pmo_nivel_ = Number(
                this.tmp_operacionCobroPractica.pmo_nivel
              );
              ...
              if (pmo_nivel_ !== 2 && pmo_nivel_ !== 4) {
                ...
                this.throwAlert(
                  ...
                  'La practica no tiene distribución asignada',
                  '500'
                );
              }
            }
            ...
            if (resp[0]) {
              this.coseguro_id = resp[0].id;
            }

            this.tmp_operacionCobroPractica.categorizacion =
              this.categoria_coseguro;
            ...
            if (es_habilitada === 'S') {
              // OJO SI NO FUNCIONA ALGO ESTO FUE AGREGADO EL 22-07-2019 PARA QUE LOS COSEGUROS QUE NO ESTEN HABILITADOS NO LOS CARGUE
              this.veinteporciento = this.cargarCoseguroRegistro(
                Number(this.tmp_operacionCobroPractica.valor_facturado)
              ); // EVALUAR SU ELIMINACION YA ESTA CALCULADO EN LA BASE DE DATOS
              ...
              this.operacionCobroPractica = new OperacionCobroPractica(
                this.tmp_operacionCobroPractica.id,
                this.coseguro_id,
                this.popItemCoseguro.nombre +
                  ' - ' +
                  this.tmp_operacionCobroPractica.pmo_descripcion,
                this.tmp_operacionCobroPractica.obra_social_nombre,
                this.popItemCoseguro.id,
                this.veinteporciento,
                this.veinteporciento,
                this.tmp_operacionCobroPractica.operacion_cobro_id,
                this.tmp_operacionCobroPractica.observacion,
                this.tmp_operacionCobroPractica.pmo_id,
                this.tmp_operacionCobroPractica.pmo_nivel,
                this.categoria_coseguro,
                this.tmp_operacionCobroPractica.cantidad,
                this.popItemCoseguro.es_coseguro,
                this.popItemCoseguro.tiene_distribucion,
                this.total_honorario_obra_social,
                this.total_honorario_coseguro,
                ...
                this.usuario_id,
                'P',
                this.tmp_operacionCobroPractica.usuario_cobro_nombre,
                'NO',
                '-',
                '',
                'NO',
              ...
              this.operacionCobroPracticas[
                this.operacionCobroPracticas.length - 2
              ].total_honorario_coseguro =
                this.operacionCobroPracticas[
                  this.operacionCobroPracticas.length - 1
                ].total_honorario_coseguro;
              this.operacionCobroPracticas[
                this.operacionCobroPracticas.length - 2
              ].total_honorario_obra_social =
                this.operacionCobroPracticas[
                  this.operacionCobroPracticas.length - 1
                ].total_honorario_obra_social;
  ...
  RealizarCobro() {
    ...
    if (this.formDatosObraSocial.value.bono_afiliado != '') {
      ...
      this.operacionCobro = new OperacionCobro(
        '0',
        this.formObraSocial.value.id,
        this.formPaciente.value.id,
        this.valTotalFinal,
        this.total_obra_social,
        this.total_coseguro,
        this.total_categoria,
        ...
        this._fechaHoy,
        'COBRADO',
        this.operacionCobroMedico,
        this.operacionCobroPracticas,
        this.observacion,
        this.formDatosObraSocial.value.bono_afiliado,
        'NO',
      ...
      try {
        this.miServico.postOperacionCobro(this.operacionCobro).subscribe(
          (resp) => {
            ...
            swal(
              ...
              'La operación Nº ' +
                myStr +
                ' se a guardado con exito. Con un total de $' +
                resp.total_operacion_cobro,
              'success'
            );
      ...
      this.throwAlert(
        'warning',
        'Error: Practica sin numero de bono',
        'Practica sin numero de bono',
        '404'
      );
    }
  }
  ...
  actualizarTurno() {
    try {
      ...
      console.log(this.popItemAgendaInicio);
      this.agendaService
        .updateAgendaOperacionCobro(
          this.popItemAgendaInicio,
          this.operacioncobro_id
        )
        .subscribe(
          (resp) => {
            console.log(JSON.stringify(resp));
