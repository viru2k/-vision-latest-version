...
export class HistoriaClinicaComponent implements OnInit {
  ...
  constructor(
    ...
    this.listarecetas = [
      ...
      {
        label: 'TEXTO CON DIAGNOSTICO',
        value: {
          id: 1,
          name: 'TEXTO CON DIAGNOSTICO',
          code: 'TEXTO CON DIAGNOSTICO',
        },
      },
      ...
      {
        label: 'PAQUIMETRIA CORNEAL',
        value: {
          id: 5,
          name: 'PAQUIMETRIA CORNEAL',
          code: 'PAQUIMETRIA CORNEAL',
        },
      },
      {
        label: 'TOPOGRAFIA CORNEAL',
        value: {
          id: 6,
          name: 'TOPOGRAFIA CORNEAL',
          code: 'TOPOGRAFIA CORNEAL',
        },
      },
      {
        label: 'RECUENTO ENDOTELIAL',
        value: {
          id: 7,
          name: 'RECUENTO ENDOTELIAL',
          code: 'RECUENTO ENDOTELIAL',
        },
      },
      {
        label: 'OCT DE MACULA',
        value: { id: 8, name: 'OCT DE MACULA', code: 'OCT DE MACULA' },
      },
      {
        label: 'OCT DE PAPILA',
        value: { id: 9, name: 'OCT DE PAPILA', code: 'OCT DE PAPILA' },
      },
      { label: 'VERION', value: { id: 10, name: 'VERION', code: 'VERION' } },
      {
        label: 'YAG LASER',
        value: { id: 10, name: 'VERION', code: 'YAG LASER' },
      },
      {
        label: 'LASER ARGON',
        value: { id: 10, name: 'VERION', code: 'LASER ARGON' },
      },
    ];
  ...
  ngOnInit() {
    if (this.paciente != null) {
      ...
      this.formPaciente.patchValue({
        paciente_nombre:
          this.paciente.paciente_apellido + ' ' + this.paciente.paciente_nombre,
      });
      this.formPaciente.patchValue({ paciente_id: this.paciente.id });
      this.formPaciente.patchValue({
        numero_afiliado: this.paciente.numero_afiliado,
      });
      this.formPaciente.patchValue({ plan: this.paciente.plan });
      this.formPaciente.patchValue({ domicilio: this.paciente.domicilio });
      this.formPaciente.patchValue({
        obra_social_nombre: this.paciente.paciente_obra_social_nombre,
      });
      this.formPaciente.patchValue({ dni: this.paciente.paciente_dni });
      this.formPaciente.patchValue({
        barra_afiliado: this.paciente.barra_afiliado,
      });
      this.formPaciente.patchValue({
        numero_afiliado: this.paciente.numero_afiliado,
      });
      this.formPaciente.patchValue({
        paciente_obra_social_id: this.paciente.paciente_obra_social_id,
      });

      this.edad =
        new Date().getFullYear() -
        new Date(this.paciente.paciente_fecha_nacimiento).getFullYear();
      this.formPaciente.patchValue({ edad: this.edad });
      console.log(this.formPaciente);
      this.loadhistoriaClinica();
    } else {
      //10029750
      this.paciente = new AgendaTurno(
        '',
        new Date(),
        new Date(),
        new Date(),
  ...
  verReceta() {
    ...
    if (this.selectedReceta['label'] === 'TEXTO') {
    } else {
    }
  ...
  buscarPaciente() {
    ...
    ref.onClose.subscribe((PopupPacienteObrasocialComponent: Paciente) => {
      if (PopupPacienteObrasocialComponent) {
        ...
        this.formPaciente.patchValue({
          paciente_nombre:
            this.popItemPaciente.apellido + ' ' + this.popItemPaciente.nombre,
        });
        ...
        this.formPaciente.patchValue({
          obra_social: this.popItemPaciente.obra_social_nombre,
        });
        this.edad =
          new Date().getFullYear() -
          new Date(this.popItemPaciente.fecha_nacimiento).getFullYear();
        this.formPaciente.patchValue({ edad: this.edad });
        this.formPaciente.patchValue({
          numero_afiliado: PopupPacienteObrasocialComponent.numero_afiliado,
        });
        this.formPaciente.patchValue({
          plan: PopupPacienteObrasocialComponent.plan,
        });
        this.formPaciente.patchValue({
          dni: PopupPacienteObrasocialComponent.dni,
        });
  ...
  agregarHistoria() {
    if (this.paciente) {
      ...
      this.elemento = new HistoriaClinica(
        '',
        '',
        userData['id'],
        userData['nombreyapellido'],
        '',
        '',
        '',
        '',
        ...
        userData['nombreyapellido'],
        '',
        this.paciente.paciente_dni,
        this.formPaciente.value.plan,
        this.formPaciente.value.numero_afiliado,
        this.formPaciente.value.edad,
        this.formPaciente.value.obra_social_nombre,
        '',
        this.formPaciente.value.paciente_nombre,
        '',
        this.formPaciente.value.dni,
        '',
        '',
        '',
        '',
        ...
        this.paciente.paciente_obra_social_id,
        this.paciente.barra_afiliado,
        this.formPaciente.value.historia_clinica,
        '',
        '',
        ''
      );
      ...
      ref.onClose.subscribe(
        (PopupHistoriaClinicaRegistroNuevoComponent: HistoriaClinica) => {
  ...
  verHistoriaClinicaListado() {
    ...
    ref.onClose.subscribe(
      (PopupHistoriaClinicaListaConsultaComponent: HistoriaClinica) => {
        if (PopupPacienteObrasocialComponent) {
          console.log(PopupPacienteObrasocialComponent);
        }
      }
  ...
  this.dataForm.patchValue({plan: this.elemento.plan}); */
    if (this.formPaciente.value) {
      ...
      this.formPaciente.patchValue({
        nombreyapellido: userData['nombreyapellido'],
      });
      this.formPaciente.patchValue({
        medico_nombre: userData['nombreyapellido'],
      });
      console.log(this.diagnostico_receta);
      this.formPaciente.patchValue({
        TRATAMIENTO_MEDICO: this.historia_clinicadiagnostico,
      });
      try {
        this.miServicio
          .setHistoriaClinicaFicha(this.formPaciente.value)
          .subscribe(
            (resp) => {
              swal({
                toast: false,
  ...
  derivarAsesoramiento() {
    ...
    let agenda = new AgendaTurno(
      ...
      this.paciente.paciente_dni,
      this.paciente.paciente_fecha_nacimiento,
      this.paciente.paciente_obra_social_id,
      this.paciente.paciente_obra_social_nombre,
      '',
      '',
      '',
      '',
    ...
    ref.onClose.subscribe(
      (PopupDerivarAsesoramientoComponent: HistoriaClinica) => {
        if (PopupPacienteObrasocialComponent) {
          console.log(PopupPacienteObrasocialComponent);
        }
      }
  ...
  loadhistoriaClinica() {
    ...
    try {
      this.miServicio
        .getHistoriaClinicaByPaciente(this.paciente.paciente_dni)
        .subscribe(
          (resp) => {
            this.elementos = resp;
            console.log(resp);
  ...
  darTurno() {
    ...
    this.router.navigate(['/medico/turnos'], {
      state: { paciente: this.popItemAgenda },
    });
  }
  ...
  imprimirRenglon(elemento) {
    ...
    doc.text(
      'Obra social: ' + this.formPaciente.value.obra_social_nombre,
      10 + x,
      15 + y
    );
    ...
    if (this.formPaciente.value.paciente_obra_social_id == '1') {
      ...
      if (this.formPaciente.value.plan === '0') {
        doc.text(
          'Numero: ' +
            this.formPaciente.value.numero_afiliado +
            '/' +
            this.formPaciente.value.barra_afiliado,
          10 + x,
          20 + y
        );
      } else {
      ...
      if (this.formPaciente.value.plan === '0') {
        doc.text(
          'Numero: ' + this.formPaciente.value.numero_afiliado,
          10 + x,
          20 + y
        );
      } else {
    ...
    if (elemento.OBS_LENTES) {
      doc.text(
        'Observación de lentes : ' + elemento.OBS_LENTES,
        10 + x,
        35 + y
      );
    }
  ...
  imprimirRecetaEscrita() {
    ...
    if (
      this.selectedReceta[0]['name'] === 'TEXTO' ||
      this.selectedReceta[0]['name'] === 'TEXTO CON DIAGNOSTICO'
    ) {
    } else {
    ...
    if (haytexto) {
      if (this.diagnostico_receta != '') {
        var splitTitle_texto = doc.splitTextToSize(
          this.diagnostico_receta,
          +60
        );
        // VARIABLE PARA GUARDAR EN HC
        this.historia_clinicadiagnostico =
          this.historia_clinicadiagnostico + '  ' + splitTitle_texto;
      ...
      if (this.diagnostico_receta != '' || this.diagnostico_receta) {
        var splitTitle_diagnostico = doc.splitTextToSize(
          this.diagnostico_receta,
          +60
        );
        // VARIABLE PARA GUARDAR EN HC
        this.historia_clinicadiagnostico =
          'Diagnostico presuntivo :' + splitTitle_diagnostico + '  ';
      ...
      if (this.historia_clinica_resumen !== '') {
        var splitTitle_historia_clinica = doc.splitTextToSize(
          this.historia_clinica_resumen,
          90
        );
        ...
        for (var i = 0; i < splitTitle_historia_clinica.length; i++) {
          ...
          doc.text(
            10 + x,
            xy_historia_clinica + y,
            splitTitle_historia_clinica[i]
          );
          y = y + 5;
        }
      }
  ...
  imprimirHistoriaClinica() {
    ...
    for (i = 0; i < this.elementos.length; i++) {
      ...
      if (this.elementos[i]['FECHA']) {
        doc.text(
          'FECHA: ' +
            formatDate(this.elementos[i]['FECHA'], 'dd/MM/yyyy HH:mm', 'en'),
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['MEDICONOM']) {
        doc.text(
          'MEDICO: ' + this.elementos[i]['MEDICONOM'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['MC']) {
        ...
        renglon = renglon + 5;
        var splitTitle_texto_mc = doc.splitTextToSize(
          this.elementos[i]['MC'],
          +150
        );
      ...
      if (this.elementos[i]['SINTOMAS']) {
        ...
        renglon = renglon + 5;
        var splitTitle_texto_sintomas = doc.splitTextToSize(
          this.elementos[i]['SINTOMAS'],
          +150
        );
      ...
      if (this.elementos[i]['SINTOMAS_SIGNOS']) {
        doc.text(
          'SINTOMAS Y SIGNOS: ' + this.elementos[i]['SINTOMAS_SIGNOS'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['TRATAMIENT']) {
        doc.text(
          'TRATAMIENTO: ' + this.elementos[i]['TRATAMIENT'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['DIAGNOSTIC']) {
        doc.text(
          'DIAGNOSTICO: ' + this.elementos[i]['DIAGNOSTIC'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['COMENTARIO']) {
        doc.text(
          'COMENTARIO: ' + this.elementos[i]['COMENTARIO'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['OBS_LENTES']) {
        doc.text(
          'OBS LENTES: ' + this.elementos[i]['OBS_LENTES'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['OBSERVACIO']) {
        doc.text(
          'OBSERVACION: ' + this.elementos[i]['OBSERVACIO'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['estudio_nombre']) {
        doc.text(
          'ESTUDIO: ' + this.elementos[i]['estudio_nombre'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (
        this.elementos[i]['REFRACCION_OD'] ||
        this.elementos[i]['REFRACCION_OD']
      ) {
        doc.text(
          'REFRACCION OD: ' +
            ...
            ' ' +
            'REFRACCION OI: ' +
            this.elementos[i]['REFRACCION_OI'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (
        this.elementos[i]['CICLOPEGIA_OD'] ||
        this.elementos[i]['CICLOPEGIA_OI']
      ) {
        doc.text(
          'CICLOPEGIA OD: ' +
            this.elementos[i]['CICLOPEGIA_OD'] +
      ...
      if (this.elementos[i]['FONDO_OD'] || this.elementos[i]['FONDO_OI']) {
        doc.text(
          'FONDO OD: ' +
            this.elementos[i]['FONDO_OD'] +
            ' ' +
            'FONDO OI: ' +
            this.elementos[i]['FONDO_OI'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['PIO_OD'] || this.elementos[i]['PIO_OI']) {
        doc.text(
          'PIO OD: ' +
            this.elementos[i]['PIO_OD'] +
            ' ' +
            'PIO OI: ' +
            this.elementos[i]['PIO_OI'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['BIO_OD'] || this.elementos[i]['BIO_OI']) {
        doc.text(
          'BIO OD: ' +
            this.elementos[i]['BIO_OD'] +
            ' ' +
            'BIO OI: ' +
            this.elementos[i]['BIO_OI'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (
        this.elementos[i]['DIAGNOSTICO_OD'] ||
        this.elementos[i]['DIAGNOSTICO_OI']
      ) {
        doc.text(
          'DIAGNOSTICO OD: ' +
            this.elementos[i]['DIAGNOSTICO_OD'] +
      ...
      if (this.elementos[i]['TRATAMIENTO_QUIRURGICO']) {
        doc.text(
          'TRATAMIENTO QUIRURGICO: ' +
            this.elementos[i]['TRATAMIENTO_QUIRURGICO'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['TRATAMIENTO_MEDICO']) {
        doc.text(
          'TRATAMIENTO MEDICO: ' + this.elementos[i]['TRATAMIENTO_MEDICO'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
      ...
      if (this.elementos[i]['ESTUDIOSES']) {
        doc.text(
          'FONDO DE OJO: ' + this.elementos[i]['ESTUDIOSES'],
          15 + x,
          30 + y + renglon
        );
        renglon = renglon + 5;
  ...
  imprimirReceta() {
    ...
    if (this.formPaciente.value.CERCA_OI_C) {
      if (this.formPaciente.value.CERCA_OI_C.charAt(0) !== '-') {
        CERCA_OI_C = '+' + this.formPaciente.value.CERCA_OI_C;
      } else {
        CERCA_OI_C = this.formPaciente.value.CERCA_OI_C;
      }
    }
    /** EJES  */
    if (
      this.formPaciente.value.CERCA_OI_2 === null ||
      this.formPaciente.value.CERCA_OI_2 === ''
    ) {
    } else {
      CERCA_OI_2 = this.formPaciente.value.CERCA_OI_2 + '°';
    }
    if (
      this.formPaciente.value.CERCA_OD_2 === null ||
      this.formPaciente.value.CERCA_OD_2 === ''
    ) {
    } else {
    ...
    if (
      this.formPaciente.value.LEJOS_OD_2 === null ||
      this.formPaciente.value.LEJOS_OD_2 === ''
    ) {
    } else {
    ...
    if (
      this.formPaciente.value.LEJOS_OI_2 === null ||
      this.formPaciente.value.LEJOS_OI_2 === ''
    ) {
    } else {
