...
export class PopupObraSocialMedicoComponent implements OnInit {
  ...
  constructor(
    ...
    this.colsObraSocial = [{ field: 'dia_nombre', header: 'Dia' }];
  }
  ...
  loadListObraSocialBymedico() {
    this.loading = true;
    try {
      this.medicoObraSocialService.getItemsByMedico(this.medico_id).subscribe(
        (resp) => {
  ...
  guardar() {
    ...
    this.nuevomedicoobrasocial = new MedicoObraSocial(
      '',
      '',
      this.selectedItemObraSocial.id,
      this.medico_id,
      this.config.data.apellido,
      this.config.data.usuario_id,
      new Date(),
      this.selectedItemObraSocial.es_habilitada,
      this.selectedItemObraSocial.nombre,
      this.config.data.codigo_old
    );
    this.nuevoItem();
  }
  ...
  borrar() {
    try {
      this.medicoObraSocialService.delItem(this.medicoobrasocial).subscribe(
        (resp) => {
          //this.elemento = resp;
          console.log(resp);
          this.showToast(
  ...
  nuevoItem() {
    try {
      this.medicoObraSocialService
        .postItem(this.nuevomedicoobrasocial)
        .subscribe(
          (resp) => {
            //this.elemento = resp;
            console.log(resp);
