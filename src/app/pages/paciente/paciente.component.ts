...
export class PacienteComponent implements OnInit {
  ...
  constructor(
    private miServico: PacienteService,
  ...
  showDialogToUpdate(event) {
    ...
    this.popItem = new Paciente(
      ...
      event.data.sexo,
      event.data.fecha_nacimiento,
      event.data.ciudad,
      event.data.telefono_fijo,
      event.data.telefono_cel,
      event.data.email,
      event.data.tiene_whatsapp,
      event.data.obra_social_id,
      event.data.obra_social_nombre,
      event.data.coseguro_nombre,
      event.data.coseguro_id,
      event.data.usuario_alta_id,
      event.data.numero_afiliado,
      event.data.barra_afiliado,
      event.data.plan,
      event.data.tiene_distribucion,
      event.data.es_coseguro,
      event.data.coseguro_tiene_distribucion,
      event.data.coseguro_es_coseguro,
      event.data.es_habilitada,
      event.data.gravado_adherente
    );
  ...
  loadList() {
    this.loading = true;
    try {
      this.miServico.getItems(this.busqueda, this.textoBusqueda).subscribe(
        (resp) => {
          this.elementos = resp;
          this.loading = false;
          console.log(resp);
