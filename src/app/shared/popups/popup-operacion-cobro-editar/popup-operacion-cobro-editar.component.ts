...
export class PopupOperacionCobroEditarComponent implements OnInit {
  ...
  constructor(
    ...
    this.updateDataForm = new FormGroup({
      ...
      operacion_cobro_total_operacion_cobro: new FormControl({
        value: 0,
        disabled: true,
      }),
  ...
  buscarObraSocial() {
    ...
    ref.onClose.subscribe((PopupObraSocialComponent: ObraSocial) => {
      if (PopupObraSocialComponent) {
        ...
        this.updateDataForm.patchValue({
          operacion_cobro_obra_social_nombre: PopupObraSocialComponent.nombre,
        });
        this.updateDataForm.patchValue({
          operacion_cobro_obra_social_id: PopupObraSocialComponent.id,
        });
      }
    });
  }
