 ...
 */
  ...
  loadList() {
    ...
    try {
      this.miServico
        .getItemsByObraSocialAndCoseguro(
          this.config.data.id,
          this.config.data.coseguro_id
        )
        .subscribe(
          (resp) => {
            this.elementos = resp;
  ...
  onRowSelect(event) {
    ...
    if (
      this.selectedItem.obra_social_id == '99' ||
      this.selectedItem.obra_social_id == '86'
    ) {
      this.display = true;
    }
  }
  ...
  guardarDato() {
    ...
    if (this.selectedItem != null) {
      ...
      this.selectedItemPractica.obra_social_id =
        this.selectedItem.obra_social_id;
      this.selectedItemPractica.obra_social_nombre =
        this.selectedItem.obra_social_nombre;
      ...
      this.selectedItemPractica.pmo_descripcion =
        this.selectedItem.pmo_descripcion;
      this.selectedItemPractica.obra_social_id =
        this.selectedItem.obra_social_id;
      ...
      this.throwAlert(
        'alerta',
        'Error en el tipo de dato seleccionado',
        '¿Selecciono un registro para combinar?',
        'sin error'
      );
    }
  }
