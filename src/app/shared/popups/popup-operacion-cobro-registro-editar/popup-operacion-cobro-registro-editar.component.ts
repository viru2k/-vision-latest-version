...
export class PopupOperacionCobroRegistroEditarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.updateDataForm.patchValue({
      nombreyapellido:
        this.config.data.apellido + ' ' + this.config.data.nombre,
    });
  ...
  buscarPaciente() {
    ...
    ref.onClose.subscribe((PopupPacienteObrasocialComponent: Paciente) => {
      if (PopupPacienteObrasocialComponent) {
        ...
        this.updateDataForm.patchValue({
          paciente_id: PopupPacienteObrasocialComponent.id,
        });
        this.updateDataForm.patchValue({
          nombreyapellido:
        ...
        this.updateDataForm.patchValue({
          apellido: PopupPacienteObrasocialComponent.apellido,
        });
        this.updateDataForm.patchValue({
          nombre: PopupPacienteObrasocialComponent.nombre,
        });
        console.log(this.updateDataForm.value);
      }
    });
  ...
  buscarMedico() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        ...
        this.updateDataForm.patchValue({
          user_medico_id: PopupMedicoComponent.usuario_id,
        });
        console.log(this.updateDataForm.value);
      }
    });
  ...
  buscarPractica() {
    ...
    ref.onClose.subscribe((PopupConvenioComponent: Convenio) => {
      if (PopupConvenioComponent) {
        ...
        this.updateDataForm.patchValue({
          convenio_os_pmo_id: PopupConvenioComponent.id,
        });
        this.updateDataForm.patchValue({
          codigo: PopupConvenioComponent.codigo,
        });
        this.updateDataForm.patchValue({
          descripcion: PopupConvenioComponent.pmo_descripcion,
        });
        this.updateDataForm.patchValue({
          valor_original: PopupConvenioComponent.valor,
        });
        this.updateDataForm.patchValue({
          obra_social_nombre: PopupConvenioComponent.obra_social_nombre,
        });
      }
    });
  }
  ...
  editarPaciente() {
    ...
    ref.onClose.subscribe((PopupPacienteConsultaComponent: Paciente) => {
      if (PopupPacienteObrasocialComponent) {
        ...
        console.log(this.popItemPaciente);
        this.updateDataForm.patchValue({
          paciente_id: PopupPacienteConsultaComponent.id,
        });
        this.updateDataForm.patchValue({
          operacion_cobro_paciente_nombre:
            PopupPacienteConsultaComponent.apellido +
            ' ' +
            PopupPacienteConsultaComponent.nombre,
        });
