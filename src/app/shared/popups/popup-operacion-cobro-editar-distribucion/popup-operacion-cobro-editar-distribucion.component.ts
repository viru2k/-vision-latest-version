...
export class PopupOperacionCobroEditarDistribucionComponent implements OnInit {
  ...
  editRow(row) {
    ...
    try {
      this.miServicio.updateOperacionCobroDistribucion(this.popItem).subscribe(
        (resp) => {
          console.log(resp);
  ...
  actualizarCobro(elemento: any) {
    ...
    try {
      this.miServicio
        .updateOperacionCobroDistribucionOperacionCobro(this.elemento)
        .subscribe(
          (resp) => {
            console.log(resp);
  ...
  loadRegistro() {
    ...
    try {
      this.miServicio
        .getOperacionCobroByDistribucion(this._fechaDesde, this._fechaHasta)
        .subscribe(
          (resp) => {
            console.log(resp);
            if (resp[0]) {
