...
export class PopupFichaQuirurgicaMedicoGrupoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.config.data.cirugia_medico_grupo_id !== 0) {
      ...
      this.FormFicha.patchValue({
        cirugia_grupo_medico_id: this.config.data['cirugia_grupo_medico_id'],
      });
  ...
  loadList() {
    try {
      this.miServicio
        .getFichaMedicoGrupo(this.elemento['cirugia_medico_grupo_id'])
        .subscribe(
          (resp) => {
            console.log(resp);
            let result: any = resp;
            ...
            this.FormFicha.patchValue({
              cirugia_ficha_id: this.elemento['id'],
            });
            console.log(this.FormFicha.value);
          },
          (error) => {
  ...
  guardarDatos() {
    if (this.tiene_datos) {
      if (
        this.FormFicha.value.medico_opera_id !== 0 &&
        this.FormFicha.value.medico_deriva_id !== 0 &&
        this.FormFicha.value.medico_ayuda_id !== 0 &&
        this.FormFicha.value.medico_factura_id !== 0 &&
        this.FormFicha.value.medico_anestesista_id !== 0
      ) {
        console.log(this.FormFicha.value);
        try {
          this.miServicio
            .putFichaMedicoGrupo(
              ...
              this.FormFicha.value.cirugia_grupo_medico_id
            )
            .subscribe(
              (resp) => {
                console.log(resp);
      ...
      if (
        ...
        try {
          this.miServicio
            .postLenteFichaMedicoGrupo(this.FormFicha.value)
            .subscribe(
              (resp) => {
                console.log(resp);
  ...
  buscarOpera() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        ...
        this.FormFicha.patchValue({
          medico_opera_id: PopupMedicoComponent.usuario_id,
        });
        console.log(this.FormFicha.value);
      }
    });
  ...
  buscarAyuda() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        ...
        this.FormFicha.patchValue({
          medico_ayuda_id: PopupMedicoComponent.usuario_id,
        });
  ...
  buscarFactura() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        console.log(PopupMedicoComponent);
        this.FormFicha.patchValue({
          medico_factura_nombre:
            PopupMedicoComponent.apellido + ' ' + PopupMedicoComponent.nombre,
        });
        this.FormFicha.patchValue({
          medico_factura_id: PopupMedicoComponent.usuario_id,
        });
  ...
  buscarDeriva() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        console.log(PopupMedicoComponent);
        this.FormFicha.patchValue({
          medico_deriva_nombre:
            PopupMedicoComponent.apellido + ' ' + PopupMedicoComponent.nombre,
        });
        this.FormFicha.patchValue({
          medico_deriva_id: PopupMedicoComponent.usuario_id,
        });
      }
    });
  }
  ...
  buscarAnestesista() {
    ...
    ref.onClose.subscribe((PopupMedicoComponent: MedicoObraSocial) => {
      if (PopupMedicoComponent) {
        console.log(PopupMedicoComponent);
        this.FormFicha.patchValue({
          medico_anestesista_nombre:
            PopupMedicoComponent.apellido + ' ' + PopupMedicoComponent.nombre,
        });
        this.FormFicha.patchValue({
          medico_anestesista_id: PopupMedicoComponent.usuario_id,
        });
        console.log(this.FormFicha.value);
      }
    });
